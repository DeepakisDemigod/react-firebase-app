...
var __PRIVATE_WatchChangeAggregator = class {
  ...
  je(e, t, n) {
    ...
    this._t(e, t) ? r2.Ne(
      ...
      r2.Be(t)
    ), this.Ue = this.Ue.insert(t, this.ut(t).delete(e)), n && (this.$e = this.$e.insert(t, n));
  }
  removeTarget(e) {
    this.Ke.delete(e);
  }
...
var __PRIVATE_IndexedDbPersistence = class ___PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, r2, i, s, o, _, a, u, c = 15) {
    ...
    this.Pi = (e2) => Promise.resolve(), !___PRIVATE_IndexedDbPersistence.v())
...
var __PRIVATE_QueryEngine = class {
  ...
  Ui(e, t) {
    ...
    (t = __PRIVATE_queryWithLimit(
      ...
      return this.$i.getDocuments(e, i).next((r4) => this.indexManager.getMinOffset(e, n).next((n2) => {
        ...
        return this.ji(t, s, i, n2.readTime) ? this.Ui(e, __PRIVATE_queryWithLimit(
          t,
          null,
          "F"
          /* LimitType.First */
   ...
   */
  Hi(e, t, n, r2) {
    return this.$i.getDocumentsMatchingQuery(e, n, r2).next((e2) => (
...
var __PRIVATE_LocalStoreImpl = class {
  constructor(e, t, n, r2) {
    this.persistence = e, this.Ji = t, this.serializer = r2, /**
     * Maps a targetID to data about its target.
     *
     * PORTING NOTE: We are using an immutable data structure on Web to make re-runs
     * of `applyRemoteEvent()` idempotent.
     */
    this.Yi = new SortedMap(__PRIVATE_primitiveComparator), /** Maps a target to its targetID. */
    // TODO(wuandy): Evaluate if TargetId can be part of Target.
    this.Zi = new ObjectMap((e2) => __PRIVATE_canonifyTarget(e2), __PRIVATE_targetEquals), /**
     * A per collection group index of the last read time processed by
     * `getNewDocumentChanges()`.
     *
     * PORTING NOTE: This is only used for multi-tab synchronization.
     */
    this.Xi = /* @__PURE__ */ new Map(), this.es = e.getRemoteDocumentCache(), this.qr = e.getTargetCache(), this.Kr = e.getBundleCache(), this.ts(n);
  }
  ts(e) {
...
var __PRIVATE_WebStorageSharedClientState = class {
  constructor(e, t, n, r2, i) {
    this.window = e, this.si = t, this.persistenceKey = n, this.Ts = r2, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.Es = this.ds.bind(this), this.As = new SortedMap(__PRIVATE_primitiveComparator), this.started = false, /**
     * Captures WebStorage events that occur before `start()` is called. These
     * events are replayed once `WebStorageSharedClientState` is started.
     */
    this.Rs = [];
    const s = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.Vs = createWebStorageClientStateKey(this.persistenceKey, this.Ts), this.fs = /** Assembles the key for the current sequence number. */
    function createWebStorageSequenceNumberKey(e2) {
      return `firestore_sequence_number_${e2}`;
    }(this.persistenceKey), this.As = this.As.insert(this.Ts, new __PRIVATE_LocalClientState()), this.gs = new RegExp(`^firestore_clients_${s}_([^_]*)$`), this.ps = new RegExp(`^firestore_mutations_${s}_(\\d+)(?:_(.*))?$`), this.ys = new RegExp(`^firestore_targets_${s}_(\\d+)$`), this.ws = /** Assembles the key for the online state of the primary tab. */
    ...
    this.window.addEventListener("storage", this.Es);
  }
  ...
  async start() {
    ...
    for (const e2 of this.Rs)
      this.ds(e2);
    this.Rs = [], // Register a window unload hook to remove the client metadata entry from
  ...
  updateMutationState(e, t, n) {
    this.Fs(e, t, n), // Once a final mutation result is observed by other clients, they no longer
...
class __PRIVATE_RestConnection {
  ...
  So(e, t, n) {
    ...
    void 0 !== a && (_.longPollingTimeout = Math.round(1e3 * a)), this.useFetchStreams && (_.xmlHttpFactory = new FetchXmlHttpFactory({})), this.po(_.initMessageHeaders, t, n), // Sending the custom headers we just added to request.initMessageHeaders
    ...
    return __PRIVATE_unguardedEventListen(c, WebChannel.EventType.OPEN, () => {
      ...
      if (!h) {
        ...
        if (o2) {
          ...
          h = true, P2.Io(new FirestoreError(n3, i3)), c.close();
        } else
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(e, t, n = 1e3, r2 = 1.5, i = 6e4) {
    this.si = e, this.timerId = t, this.bo = n, this.Do = r2, this.vo = i, this.Co = 0, this.Fo = null, /** The last backoff attempt, as epoch milliseconds. */
  ...
  Oo(e) {
    ...
    r2 > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${r2} ms (base delay: ${this.Co} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`), this.Fo = this.si.enqueueAfterDelay(this.timerId, r2, () => (this.Mo = Date.now(), e())), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
    this.Co *= this.Do, this.Co < this.bo && (this.Co = this.bo), this.Co > this.vo && (this.Co = this.vo);
  }
  Bo() {
...
var __PRIVATE_PersistentStream = class {
  constructor(e, t, n, r2, i, s, o, _) {
    this.si = e, this.Lo = n, this.ko = r2, this.connection = i, this.authCredentialsProvider = s, this.appCheckCredentialsProvider = o, this.listener = _, this.state = 0, /**
     * A close count that's incremented every time the stream is closed; used by
     * getCloseGuardedDispatcher() to invalidate callbacks that happen after
     * close.
     */
    this.qo = 0, this.Qo = null, this.Ko = null, this.stream = null, this.$o = new __PRIVATE_ExponentialBackoff(e, t);
  }
  /**
   ...
   */
  async close(e, t) {
    this.Yo(), this.Zo(), this.$o.cancel(), // Invalidates any stream-related callbacks (e.g. from auth or the
    ...
    this.qo++, 4 !== e ? (
      ...
      (__PRIVATE_logError(t.toString()), __PRIVATE_logError("Using maximum backoff delay to prevent overloading the backend."), this.$o.xo())
    ...
    null !== this.stream && (this.Xo(), this.stream.close(), this.stream = null), // This state must be assigned before calling onClose() to allow the callback to
...
var __PRIVATE_PersistentWriteStream = class extends __PRIVATE_PersistentStream {
  ...
  onMessage(e) {
    if (
      ...
      __PRIVATE_hardAssert(!!e.streamToken), this.lastStreamToken = e.streamToken, this.__
    ) {
      this.$o.reset();
...
var __PRIVATE_OnlineStateTracker = class {
  ...
  R_() {
    0 === this.E_ && (this.V_(
      "Unknown"
      /* OnlineState.Unknown */
    ), this.d_ = this.asyncQueue.enqueueAfterDelay("online_state_timeout", 1e4, () => (this.d_ = null, this.m_("Backend didn't respond within 10 seconds."), this.V_(
      "Offline"
      /* OnlineState.Offline */
    ), Promise.resolve())));
  }
   ...
   */
  f_(e) {
    "Online" === this.state ? this.V_(
      "Unknown"
      /* OnlineState.Unknown */
    ) : (this.E_++, this.E_ >= 1 && (this.g_(), this.m_(`Connection failed 1 times. Most recent error: ${e.toString()}`), this.V_(
      "Offline"
      /* OnlineState.Offline */
    )));
  }
   ...
   */
  set(e) {
    this.g_(), this.E_ = 0, "Online" === e && // We've connected to watch at least once. Don't warn the developer
    // about being offline going forward.
    (this.A_ = false), this.V_(e);
  }
  V_(e) {
...
var __PRIVATE_RemoteStoreImpl = class {
  constructor(e, t, n, r2, i) {
     ...
     */
    this.S_ = [], this.b_ = i, this.b_.Zs((e2) => {
      n.enqueueAndForget(async () => {
        __PRIVATE_canUseNetwork(this) && (__PRIVATE_logDebug("RemoteStore", "Restarting streams for network reachability change."), await async function __PRIVATE_restartNetwork(e3) {
          ...
          ), await __PRIVATE_disableNetworkInternal(t2), t2.D_.set(
            "Unknown"
            /* OnlineState.Unknown */
          ), t2.w_.delete(
            4
...
function __PRIVATE_remoteStoreListen(e, t) {
  const n = __PRIVATE_debugCast(e);
  n.y_.has(t.targetId) || // Mark this as something the client is currently listening for.
  (n.y_.set(t.targetId, t), __PRIVATE_shouldStartWatchStream(n) ? (
    // The listen will be sent in onWatchStreamOpen
    __PRIVATE_startWatchStream(n)
  ) : __PRIVATE_ensureWatchStream(n).Wo() && __PRIVATE_sendWatchRequest(n, t));
}
function __PRIVATE_remoteStoreUnlisten(e, t) {
  const n = __PRIVATE_debugCast(e), r2 = __PRIVATE_ensureWatchStream(n);
  n.y_.delete(t), r2.Wo() && __PRIVATE_sendUnwatchRequest(n, t), 0 === n.y_.size && (r2.Wo() ? r2.jo() : __PRIVATE_canUseNetwork(n) && // Revert to OnlineState.Unknown if the watch stream is not open and we
...
async function __PRIVATE_onWatchStreamClose(e, t) {
  ...
  __PRIVATE_shouldStartWatchStream(e) ? (e.D_.f_(t), __PRIVATE_startWatchStream(e)) : (
      ...
      */
      function __PRIVATE_raiseWatchSnapshot(e2, t3) {
        ...
        n2.targetMismatches.forEach((t4, n3) => {
          ...
          if (!r2)
            return;
          e2.y_.set(t4, r2.withResumeToken(ByteString.EMPTY_BYTE_STRING, r2.snapshotVersion)), // Cause a hard reset by unwatching and rewatching immediately, but
...
async function __PRIVATE_disableNetworkUntilRecovery(e, t, n) {
  ...
  await __PRIVATE_disableNetworkInternal(e), e.D_.set(
    "Offline"
    /* OnlineState.Offline */
  ...
  e.asyncQueue.enqueueRetryable(async () => {
    __PRIVATE_logDebug("RemoteStore", "Retrying IndexedDB access"), await n(), e.w_.delete(
      1
      /* OfflineCause.IndexedDbFailed */
...
async function __PRIVATE_onWriteStreamClose(e, t) {
  t && __PRIVATE_ensureWriteStream(e).a_ && // This error affects the actual write.
...
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  ...
  t ? (n.w_.delete(
    ...
    2
    /* OfflineCause.IsSecondary */
  ), await __PRIVATE_disableNetworkInternal(n), n.D_.set(
    "Unknown"
    /* OnlineState.Unknown */
  ));
}
function __PRIVATE_ensureWatchStream(e) {
  ...
  (e.C_ = function __PRIVATE_newPersistentWatchStream(e2, t, n) {
    ...
    t ? (e.C_.zo(), __PRIVATE_shouldStartWatchStream(e) ? __PRIVATE_startWatchStream(e) : e.D_.set(
      "Unknown"
      /* OnlineState.Unknown */
    )) : (await e.C_.stop(), __PRIVATE_cleanUpWatchStreamState(e));
  })), e.C_;
}
function __PRIVATE_ensureWriteStream(e) {
  return e.F_ || // Create stream (but note that it is not started yet).
  (e.F_ = function __PRIVATE_newPersistentWriteStream(e2, t, n) {
    const r2 = __PRIVATE_debugCast(e2);
    ...
    t ? (e.F_.zo(), // This will start the write stream if necessary.
    await __PRIVATE_fillWritePipeline(e)) : (await e.F_.stop(), e.p_.length > 0 && (__PRIVATE_logDebug("RemoteStore", `Stopping write stream with ${e.p_.length} pending writes`), e.p_ = []));
  })), e.F_;
}
...
var __PRIVATE_DocumentChangeSet = class {
  ...
  track(e) {
    ...
    n ? (
      ...
      0 !== e.type && 3 === n.type ? this.M_ = this.M_.insert(t, e) : 3 === e.type && 1 !== n.type ? this.M_ = this.M_.insert(t, {
        type: n.type,
        doc: e.doc
...
var __PRIVATE_QueryListener = class {
  constructor(e, t, n) {
    this.query = e, this.k_ = t, /**
     * Initial snapshots (e.g. from cache) may not be propagated to the wrapped
     * observer. This flag is set to true once we've actually raised an event.
     */
    this.q_ = false, this.Q_ = null, this.onlineState = "Unknown", this.options = n || {};
  }
  /**
...
var __PRIVATE_BundleLoader = class {
  constructor(e, t, n) {
    this.H_ = e, this.localStore = t, this.serializer = n, /** Batched queries to be saved into storage */
...
var __PRIVATE_View = class {
  constructor(e, t) {
    this.query = e, this.ea = t, this.ta = null, this.hasCachedResults = false, /**
    ...
    this.na = __PRIVATE_documentKeySet(), /** Document Keys that have local changes */
    this.mutatedKeys = __PRIVATE_documentKeySet(), this.ra = __PRIVATE_newQueryComparator(e), this.ia = new DocumentSet(this.ra);
  }
  /**
    ...
    if (e.inorderTraversal((e2, t2) => {
      ...
      if (u && c) {
        u.data.isEqual(c.data) ? l2 !== h && (n.track({
          ...
          type: 2,
          doc: c
        }), P2 = true, (_ && this.ra(c, _) > 0 || a && this.ra(c, a) < 0) && // This doc moved from inside the limit to outside the limit.
  ...
  ha(e) {
    ...
    (!!this.ia.has(e) && !this.ia.get(e).hasLocalMutations);
  }
  /**
...
var __PRIVATE_SyncEngineImpl = class {
  constructor(e, t, n, r2, i, s) {
    this.localStore = e, this.remoteStore = t, this.eventManager = n, this.sharedClientState = r2, this.currentUser = i, this.maxConcurrentLimboResolutions = s, this.Ea = {}, this.da = new ObjectMap((e2) => __PRIVATE_canonifyQuery(e2), __PRIVATE_queryEquals), this.Aa = /* @__PURE__ */ new Map(), /**
     ...
     */
    this.ma = /* @__PURE__ */ new Map(), this.fa = new __PRIVATE_ReferenceSet(), /** Stores user completion handlers, indexed by User and BatchId. */
    this.ga = {}, /** Stores user callbacks waiting for all pending writes to be acknowledged. */
    this.pa = /* @__PURE__ */ new Map(), this.ya = __PRIVATE_TargetIdGenerator.Nn(), this.onlineState = "Unknown", // The primary state is set to `true` or `false` immediately after Firestore
...
async function __PRIVATE_syncEngineApplyRemoteEvent(e, t) {
  ...
  try {
    ...
    t.targetChanges.forEach((e3, t2) => {
      ...
      (__PRIVATE_hardAssert(e3.addedDocuments.size + e3.modifiedDocuments.size + e3.removedDocuments.size <= 1), e3.addedDocuments.size > 0 ? r2.Ta = true : e3.modifiedDocuments.size > 0 ? __PRIVATE_hardAssert(r2.Ta) : e3.removedDocuments.size > 0 && (__PRIVATE_hardAssert(r2.Ta), r2.Ta = false));
...
async function __PRIVATE_syncEngineRejectListen(e, t, n) {
  ...
  if (s) {
    ...
    r2.Va = r2.Va.remove(s), r2.ma.delete(t), __PRIVATE_pumpEnqueuedLimboResolutions(r2);
  } else
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  if (e.Aa.delete(t), e.isPrimaryClient) {
    e.fa.Rr(t).forEach((t2) => {
      e.fa.containsKey(t2) || // We removed the last reference for this key
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const r2 of n)
    if (r2 instanceof __PRIVATE_AddedLimboDocument)
      ...
      e.fa.containsKey(r2.key) || // We removed the last reference for this key
...
async function __PRIVATE_syncEngineApplyActiveTargetsChange(e, t, n) {
  ...
  if (r2.wa) {
    ...
    for (const e2 of n)
      r2.Aa.has(e2) && // Release queries that are still active.
      await __PRIVATE_localStoreReleaseTarget(
        r2.localStore,
        e2,
        /* keepPersistedTargetData */
...
var __PRIVATE_IndexedDbOfflineComponentProvider = class extends MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e), await this.va.initialize(this, e), // Enqueue writes from a previous session
    await __PRIVATE_syncEngineEnsureWriteCallbacks(this.va.syncEngine), await __PRIVATE_fillWritePipeline(this.va.remoteStore), // NOTE: This will immediately call the listener, so we make sure to
...
var __PRIVATE_MultiTabOfflineComponentProvider = class extends __PRIVATE_IndexedDbOfflineComponentProvider {
  constructor(e, t) {
    super(
      ...
      /* forceOwnership= */
      false
    ), this.va = e, this.cacheSizeBytes = t, this.synchronizeTabs = true;
  }
  async initialize(e) {
...
var OnlineComponentProvider = class {
  ...
  terminate() {
    return async function __PRIVATE_remoteStoreShutdown(e) {
      const t = __PRIVATE_debugCast(e);
      __PRIVATE_logDebug("RemoteStore", "RemoteStore shutting down."), t.w_.add(
        5
        /* OfflineCause.Shutdown */
      ), await __PRIVATE_disableNetworkInternal(t), t.b_.shutdown(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var __PRIVATE_BundleReaderImpl = class {
  constructor(e, t) {
    this.Ma = e, this.serializer = t, /** Cached bundle metadata. */
    this.metadata = new __PRIVATE_Deferred(), /**
     * Internal buffer to hold bundle content, accumulating incomplete element
     * content.
     */
    this.buffer = new Uint8Array(), this.xa = function __PRIVATE_newTextDecoder() {
...
var __PRIVATE_TransactionRunner = class {
  constructor(e, t, n, r2, i) {
    this.asyncQueue = e, this.datastore = t, this.options = n, this.updateFunction = r2, this.deferred = i, this.Qa = n.maxAttempts, this.$o = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
...
function __PRIVATE_firestoreClientAddSnapshotsInSyncListener(e, t) {
  ...
  return e.asyncQueue.enqueueAndForget(async () => function __PRIVATE_addSnapshotsInSyncListener(e2, t2) {
    __PRIVATE_debugCast(e2).N_.add(t2), // Immediately fire an initial event, indicating all existing listeners
    // are in-sync.
    t2.next();
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor() {
    this.Ga = Promise.resolve(), // A list of retryable operations. Retryable operations are run in order and
    // retried with backoff.
    this.za = [], // Is this AsyncQueue being shut down? Once it is set to true, it will not
    // be changed again.
    this.ja = false, // Operations scheduled to be queued in the future. Operations are
    // automatically removed after they are run or canceled.
    this.Ha = [], // visible for testing
    this.Ja = null, // Flag set while there's an outstanding AsyncQueue operation, used for
    // assertion sanity-checks.
    this.Ya = false, // Enabled during shutdown on Safari to prevent future access to IndexedDB.
    this.Za = false, // List of TimerIds to fast-forward delays for.
    this.Xa = [], // Backoff timer used to schedule retries for retryable operations
    this.$o = new __PRIVATE_ExponentialBackoff(
      this,
      "async_queue_retry"
  ...
  enqueueAndForgetEvenWhileRestricted(e) {
    this.tu(), // eslint-disable-next-line @typescript-eslint/no-floating-promises
    this.nu(e);
  }
  ...
  enqueueAfterDelay(e, t, n) {
    this.tu(), // Fast-forward delays for timerIds that have been overriden.
    this.Xa.indexOf(e) > -1 && (t = 0);
...
var __PRIVATE_ParseContextImpl = class ___PRIVATE_ParseContextImpl {
  ...
  constructor(e, t, n, r2, i, s) {
    ...
    void 0 === i && this.uu(), this.fieldTransforms = i || [], this.fieldMask = s || [];
  }
  get path() {
...
!function __PRIVATE_registerFirestore(e, t = true) {
  ...
  }, "PUBLIC").setMultipleInstances(true)), registerVersion(S2, "4.1.1", e), // BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
  registerVersion(S2, "4.1.1", "esm2017");
}();
...
@firebase/firestore/dist/index.esm2017.js:
  ...
  *)
   ...
   *)
*/
//# sourceMappingURL=chunk-Z6ELMQKX.js.map
